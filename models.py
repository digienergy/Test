...
class EnergySummary(Base):
    ...
    grid_a_v = Column(Double, nullable=True)
    grid_b_v = Column(Double, nullable=True)
    grid_c_v = Column(Double, nullable=True)
    grid_a_c = Column(Double, nullable=True)
    grid_b_c = Column(Double, nullable=True)
    grid_c_c = Column(Double, nullable=True)
    mppt1_v = Column(Double, nullable=True)
    mppt2_v = Column(Double, nullable=True)
    mppt3_v = Column(Double, nullable=True)
    mppt4_v = Column(Double, nullable=True)
    mppt1_c = Column(Double, nullable=True)
    mppt2_c = Column(Double, nullable=True)
    mppt3_c = Column(Double, nullable=True)
    mppt4_c = Column(Double, nullable=True)   
